...
h1, h3, h4, li {
text-align: center;
color: #c9d1d9; /* color de letra claro */
}
...
h4 {
max-width: 800px;
margin: 20px auto; /* Agrega márgenes automáticos a los lados para centrar y espacio arriba/abajo */
}
...
.curious-fact, .quote {
color: #8b949e; /* color más oscuro para diferenciarlos del texto normal pero aún claro */
}


ul {
  /* Elimina el padding por defecto y establece el ancho máximo deseado para la lista */
  padding: 40;
  margin: auto;
  max-width: 700px; /* Ajusta esto al ancho que prefieras */
  text-align: justify;
}
...
img {
background-color: white; /* color de fondo para las imágenes */
border-radius: 8px; /* bordes redondeados para las imágenes */
padding: 6px; /* espacio alrededor de las imágenes */
box-shadow: 0 0 8px rgba(0, 0, 0, 0.2); /* sombra para las imágenes */
}
...
<h3 align="center" style="font-family: 'Arial', sans-serif;">Analista Programador | Estudiante de Ingeniería en Informática | Apasionado por la tecnología y soluciones innovadoras</h3>
...
<h4 style="margin-top: 20px;">Mi situación actual:</h4>
